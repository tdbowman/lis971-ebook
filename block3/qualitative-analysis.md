...
### Grounded Theory Coding (Charmaz, 2006)
...
- Ask: "What is this data a study of?" (Glaser, 1978)
...
**Inductive (bottom-up)**
: Themes are driven by the data themselves. Coding occurs without trying to fit data into pre-existing categories. Strongly linked to the data, similar in spirit to grounded theory.

**Theoretical/Deductive (top-down)**
: Themes are driven by the researcher's theoretical interest. More analyst-driven, coding for specific concepts or constructs from the literature. Provides detailed analysis of *some* aspects of the data rather than a rich description of the whole.
...
Saldaña (2016) catalogs dozens of coding methods organized into first-cycle and second-cycle approaches. Key methods for LIS dissertation researchers include:

**In Vivo coding**
: Using participants' own words as codes. Honors the participant's voice and is useful for preserving indigenous meanings.

**Process coding**
: Using gerunds exclusively to identify conceptual actions. Closely aligned with Charmaz's approach.

**Descriptive coding**
: Summarizing the topic of a passage in a word or short phrase. Useful for organizing large datasets but analytically shallow on its own.

**Values coding**
: Codes that reflect participants' values, attitudes, and beliefs. Useful for studies exploring cultural or ideological dimensions.

**Pattern coding (second cycle)**
: Grouping first-cycle codes into a smaller number of constructs or themes. A meta-coding step that moves toward higher-order explanation.

---

## Qualitative Data Analysis Software

Your methodology chapter should specify which QDA software you will use and why:

| Software | Strengths | Access |
|----------|-----------|--------|
| **NVivo** | Industry standard; powerful query tools; team coding | DU Virtual Lab |
| **QualCoder** | Free, open-source; capable for most dissertation needs | qualcoder.readthedocs.io |
| **ATLAS.ti** | Strong visualization; network building | Licensed |
...
### Tracy's (2010) Eight "Big-Tent" Criteria

Tracy proposes criteria broad enough to apply across qualitative traditions:

1. **Worthy topic**: Relevant, timely, significant, interesting
2. **Rich rigor**: Sufficient data, appropriate complexity, time in the field
3. **Sincerity**: Self-reflexivity, transparency about methods and challenges
4. **Credibility**: Thick description, triangulation, member reflections
5. **Resonance**: Transferability, naturalistic generalization
6. **Significant contribution**: Theoretically, practically, or methodologically
7. **Ethical**: Procedural ethics + situational ethics + relational ethics
8. **Meaningful coherence**: Methods match goals; study achieves what it set out to do

### Lincoln and Guba's (1985) Classic Parallel Criteria

These remain foundational and are frequently expected by dissertation committees:
...
## ✏️ Exercise: Draft Your Qualitative Analysis Plan
...
6. **Connects analysis to research questions**: Show explicitly how your analytic approach will answer each RQ
